...
final List<Question> quizzDivisibiliteFacile = [
  ...
  const Question(
    text:
        "Quel critère de divisibilité permet de déterminer qu'un nombre est divisible par 9 ?",
    options: [
  ...
  const Question(
    ...
    rationale:
        "Les multiples de 6 sont : 6, 12, 18, **24**... Les multiples de 8 sont : 8, 16, **24**...",
  ),
  const Question(
    ...
    rationale:
        "17 n'est divisible que par 1 et 17. 1, 9 et 15 ont d'autres diviseurs.",
  ),
  const Question(
    text: "Le nombre 435 est-il divisible par 5 ?",
    options: [
      "Non, car la somme de ses chiffres n'est pas 5.",
      "Oui, car il se termine par 5.",
      "Non, car il est impair.",
      "Oui, car 4 + 3 + 5 = 12.",
    ],
    correctOptionIndex: 1, // 'Oui, car il se termine par 5.'
    rationale:
        "Le critère de divisibilité par 5 exige que le dernier chiffre soit 0 ou 5.",
  ),
  const Question(
  ...
  const Question(
    text:
        "Si un nombre entier A est un diviseur d'un nombre entier B, alors B est :",
    options: [
      "Un facteur de A.",
      "Un multiple de A.",
      "Nécessairement premier.",
      "La somme de A et d'un autre nombre.",
    ],
    correctOptionIndex: 1, // 'Un multiple de A.'
    rationale:
        "Les termes 'diviseur' et 'multiple' sont réciproques : si A divise B, alors B est un multiple de A.",
  ),
  const Question(
    ...
    rationale:
        "7 est premier, et comme 10 n'est pas divisible par 7, leur seul diviseur commun est 1.",
  ),
  const Question(
    ...
    options: [
      "0 ou 5.",
      "0 ou 1.",
      "Un chiffre pair (0, 2, 4, 6, 8).",
      "Un chiffre impair (1, 3, 5, 7, 9).",
    ],
  ...
  const Question(
    ...
    rationale:
        "La somme des chiffres de 54 est 5 + 4 = 9, et 9 est divisible par 3.",
  ),
];
