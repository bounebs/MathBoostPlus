const List<String> chapitres6eme = [
...
const List<String> chapitres5eme = [
    "Nombres et Calculs : Divisibilité",
    "Nombres et Calculs : PGCD",
    "Nombres et Calculs : Fractions",
    "Nombres et Calculs : Puissance et racines carrées",
...
const List<String> chapitres4eme = [
    "Nombres et Calculs : Divisibilité",
    "Nombres et Calculs : PGCD",
    "Nombres et Calculs : Fractions",
    "Nombres et Calculs : Puissance et racines carrées",
...
const List<String> chapitres2nde = [
    "Nombres et Calculs : Divisibilité",
    "Nombres et Calculs : PGCD",
    "Nombres et Calculs : Fractions",
    "Nombres et Calculs : Puissance et racines carrées",
...
const List<String> chapitres1ere = [
    "Nombres et Calculs : Divisibilité",
    "Nombres et Calculs : PGCD",
    "Nombres et Calculs : Fractions",
    "Nombres et Calculs : Puissance et racines carrées",
...
const List<String> chapitresTerminale = [
    "Nombres et Calculs : Divisibilité",
    "Nombres et Calculs : PGCD",
    "Nombres et Calculs : Fractions",
    "Nombres et Calculs : Puissance et racines carrées",
...
List<String> getChapitres(String niveaux){
  List<String> chapitres = [];
  switch (niveaux){
    case "6ème":
    chapitres = chapitres6eme;
    case "5ème":
    chapitres = chapitres5eme;
    case "4ème":
    chapitres = chapitres4eme;
    case "3ème":
    chapitres = chapitres3eme;
    case "2nde":
    chapitres = chapitres2nde;
    case "1ère":
    chapitres = chapitres1ere;
    case "Terminale":
    chapitres = chapitresTerminale;
  }
  return chapitres;
}
